...
model = YOLO(r'D:\opencv\personCounter\best2.pt')


# Replace 'rtsp_url' with your actual RTSP stream URL
rtsp_url = "rtsp://admin:Pw123456@70.28.50.186:8554/Streaming/Channels/201"
cap = cv2.VideoCapture("Caught on Security Camera- Liquor Store Robberies.mp4")
